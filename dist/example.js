 ...
 */
export function sortNumbers(numbers, descending = false) {
 ...
 */
export function sortByMultipleKeys(items, sortKeys) {
    return [...items].sort((a, b) => {
...
export function sortDates(dates, descending = false) {
    return [...dates]
        ...
        .sort((a, b) => descending ? b.getTime() - a.getTime() : a.getTime() - b.getTime());
}
